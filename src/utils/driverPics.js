  ...
  switch (driverCode) {
    case 'HAM':
      return {
        ...
        big: 'https://www.formula1.com/content/fom-website/en/drivers/lewis-hamilton/jcr:content/image.img.1920.medium.jpg',
      };
    case 'BOT':
      return {
        profile:
          'https://www.formula1.com/content/dam/fom-website/drivers/V/VALBOT01_Valtteri_Bottas/valbot01.png',
        big: 'https://www.formula1.com/content/fom-website/en/drivers/valtteri-bottas/jcr:content/image.img.1920.medium.jpg',
      };
    case 'VER':
      return {
        profile:
          'https://www.formula1.com/content/dam/fom-website/drivers/M/MAXVER01_Max_Verstappen/maxver01.png',
        big: 'https://www.formula1.com/content/fom-website/en/drivers/max-verstappen/jcr:content/image.img.1920.medium.jpg',
      };
    case 'PER':
      return {
        profile:
          'https://www.formula1.com/content/dam/fom-website/drivers/S/SERPER01_Sergio_Perez/serper01.png',
        big: 'https://www.formula1.com/content/fom-website/en/drivers/sergio-perez/jcr:content/image.img.1920.medium.jpg',
      };
    case 'NOR':
      return {
        profile:
          'https://www.formula1.com/content/dam/fom-website/drivers/L/LANNOR01_Lando_Norris/lannor01.png',
        big: 'https://www.formula1.com/content/fom-website/en/drivers/lando-norris/jcr:content/image.img.1920.medium.jpg',
      };
    case 'STR':
      return {
        profile:
          'https://www.formula1.com/content/dam/fom-website/drivers/L/LANSTR01_Lance_Stroll/lanstr01.png',
        big: 'https://www.formula1.com/content/fom-website/en/drivers/lance-stroll/jcr:content/image.img.1920.medium.jpg',
      };
    case 'OCO':
      return {
        profile:
          'https://www.formula1.com/content/dam/fom-website/drivers/E/ESTOCO01_Esteban_Ocon/estoco01.png',
        big: 'https://www.formula1.com/content/fom-website/en/drivers/esteban-ocon/jcr:content/image.img.1920.medium.jpg',
      };
    case 'ALO':
      return {
        profile:
          'https://www.formula1.com/content/dam/fom-website/drivers/F/FERALO01_Fernando_Alonso/feralo01.png',
        big: 'https://www.formula1.com/content/fom-website/en/drivers/fernando-alonso/jcr:content/image.img.1920.medium.jpg',
      };
    case 'LEC':
      return {
        profile:
          'https://www.formula1.com/content/dam/fom-website/drivers/C/CHALEC01_Charles_Leclerc/chalec01.png',
        big: 'https://www.formula1.com/content/fom-website/en/drivers/charles-leclerc/jcr:content/image.img.1920.medium.jpg',
      };
    case 'SAI':
      return {
        profile:
          'https://www.formula1.com/content/dam/fom-website/drivers/C/CARSAI01_Carlos_Sainz/carsai01.png',
        big: 'https://www.formula1.com/content/fom-website/en/drivers/carlos-sainz/jcr:content/image.img.1920.medium.jpg',
      };
    case 'GAS':
      return {
        profile:
          'https://www.formula1.com/content/dam/fom-website/drivers/P/PIEGAS01_Pierre_Gasly/piegas01.png',
        big: 'https://www.formula1.com/content/fom-website/en/drivers/pierre-gasly/jcr:content/image.img.1920.medium.jpg',
      };
    case 'TSU':
      return {
        profile:
          'https://www.formula1.com/content/dam/fom-website/drivers/Y/YUKTSU01_Yuki_Tsunoda/yuktsu01.png',
        big: 'https://www.formula1.com/content/fom-website/en/drivers/yuki-tsunoda/jcr:content/image.img.1920.medium.jpg',
      };
    case 'RUS':
      return {
        profile:
          'https://www.formula1.com/content/dam/fom-website/drivers/G/GEORUS01_George_Russell/georus01.png',
        big: 'https://www.formula1.com/content/fom-website/en/drivers/george-russell/jcr:content/image.img.1920.medium.jpg',
      };
    case 'ALB':
      return {
        profile:
          'https://www.formula1.com/content/dam/fom-website/drivers/A/ALEALB01_Alexander_Albon/alealb01.png',
        big: 'https://www.formula1.com/content/fom-website/en/drivers/alexander-albon/jcr:content/image.img.1920.medium.jpg',
      };
    case 'ZHO':
      return {
        profile:
          'https://www.formula1.com/content/dam/fom-website/drivers/G/GUAZHO01_Guanyu_Zhou/guazho01.png',
        big: 'https://www.formula1.com/content/fom-website/en/drivers/guanyu-zhou/jcr:content/image.img.1920.medium.jpg',
      };
    case 'HUL':
      return {
        profile:
          'https://www.formula1.com/content/dam/fom-website/drivers/N/NICHUL01_Nico_Hulkenberg/nichul01.png',
        big: 'https://www.formula1.com/content/fom-website/en/drivers/nico-hulkenberg/jcr:content/image.img.1920.medium.jpg',
      };
    case 'MAG':
      return {
        profile:
          'https://www.formula1.com/content/dam/fom-website/drivers/K/KEVMAG01_Kevin_Magnussen/kevmag01.png',
        big: 'https://www.formula1.com/content/fom-website/en/drivers/kevin-magnussen/jcr:content/image.img.1920.medium.jpg',
      };
    case 'DEV':
      return {
        profile:
          'https://www.formula1.com/content/dam/fom-website/drivers/N/NYCDEV01_Nyck_De%20Vries/nycdev01.png',
        big: 'https://www.formula1.com/content/fom-website/en/drivers/nyck-de-vries/jcr:content/image.img.1920.medium.jpg',
      };
    case 'SAR':
      return {
        profile:
          'https://www.formula1.com/content/dam/fom-website/drivers/L/LOGSAR01_Logan_Sargeant/logsar01.png',
        big: 'https://www.formula1.com/content/fom-website/en/drivers/logan-sargeant/jcr:content/image.img.1920.medium.jpg',
      };
    case 'PIA':
      return {
        profile:
          'https://www.formula1.com/content/dam/fom-website/drivers/O/OSCPIA01_Oscar_Piastri/oscpia01.png',
        big: 'https://www.formula1.com/content/fom-website/en/drivers/oscar-piastri/jcr:content/image.img.1920.medium.jpg',
      };
