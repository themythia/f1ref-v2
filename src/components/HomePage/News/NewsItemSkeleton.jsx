  ...
  return (
    <Fragment>
      <div className='flex flex-row items-center w-full rounded shadow-2px dark:shadow-2px-dark bg-bg-200 dark:bg-bg-900 sm:hidden'>
        <div className='basis-2/5 bg-bg-600 shadow-2px dark:shadow-2px-dark rounded animate-pulse-tw aspect-3/2'></div>
      ...
      <div
        className={`hidden sm:block relative rounded shadow-2px dark:shadow-2px-dark bg-bg-200 dark:bg-bg-900 aspect-3/2 ${
          size === 'big'
