const CalendarItemSkeleton = () => {
  return (
    <div className='bg-bg-50 dark:bg-bg-800 rounded shadow-2px dark:shadow-2px-dark p-4 md:p-6 w-full cursor-pointer hover:scale-[1.02] hover:shadow-8px dark:hover:shadow-8px-dark duration-200 group col-span-4 sm:col-span-4 md:col-span-6 xl:col-span-4 h-24 lg:h-[120px] flex flex-col justify-center'>
      ...
      <div className='flex flex-row gap-x-4 mt-2 md:mt-3 w-full animate-pulse-tw'>
        <div className='bg-bg-600 h-9 w-9 rounded-full shadow-4px dark:shadow-4px-dark'></div>
